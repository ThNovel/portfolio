...
document
  .querySelectorAll(
    ".section-heading, .intro-grid, .featured-card, .skills-section, .current-section, .contact-section, .work-card, .expertise-item, .tool-grid span, .current-card, .writing-overview-card, .writing-card, .personal-story-intro, .story-chapter, .journal-entry, .project-copy, .project-deep-dive, .project-facts, .project-gallery figure"
  )
  .forEach((element) => {
